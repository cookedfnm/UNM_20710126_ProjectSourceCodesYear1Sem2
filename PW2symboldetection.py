...
print("FULL: Detect Saved Templates + Geometry")
...
def _side_lengths(p4):
    ...
    for i in range(4):
        x1, y1 = p4[i]
        x2, y2 = p4[(i + 1) % 4]
        a.append(float(np.hypot(x2 - x1, y2 - y1)))
    return a
            ...
            if crop_gray is None:
                ...
                while True:
                    ...
                    if k in [13, 10]:  # ENTER
                        ...
                        if chr(k).isalnum() or chr(k) in ["-", "_"]:
